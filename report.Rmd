...
def build_networks(years=years,acks=acks,informal=True):
  ...
  return networks_merged

networks_informal = build_networks()
networks_formal =  build_networks(informal=False)
